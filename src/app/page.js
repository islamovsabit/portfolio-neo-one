        ...
        <>
            <main className={styled.main}>
                <div className="container-main">
                    <div className={styled.main_content}>
                        <div data-aos="fade-up" data-aos-duration="900" data-aos-easing="linear" align="center">
                        ...
                        <ul className={styled.main_content_direction_list} data-aos="fade-up" data-aos-duration="900" data-aos-easing="linear" data-aos-delay="600">
                        ...
                        <div className={styled.main_content_btn_group} data-aos="fade-up" data-aos-duration="900" data-aos-easing="linear" data-aos-delay="800">
                        ...
                        <ul className={styled.main_content_job_list}>
                            ...
                            <li className={styled.main_content_job_item} data-aos="fade-up" data-aos-duration="900" data-aos-delay="800">
                            ...
                            <li className={styled.main_content_job_item} data-aos="fade-up" data-aos-duration="900" data-aos-delay="900">
                                <div className={`${styled.main_content_job_surrounding} ${dayMoon ? styled.background_color : ""}`}>
                            ...
                            <li className={styled.main_content_job_item} data-aos="fade-up" data-aos-duration="900" data-aos-delay="1000">
                                <div className={`${styled.main_content_job_surrounding} ${dayMoon ? styled.background_color : ""}`}>
                            ...
                            <li className={styled.main_content_job_item} data-aos="fade-up" data-aos-duration="900" data-aos-delay="1100">
                                <div className={`${styled.main_content_job_surrounding} ${dayMoon ? styled.background_color : ""}`}>
                        ...
                        <div className={`${styled.main_content_get_contact} ${dayMoon ? styled.background_color : ""}`} data-aos="fade-up" data-aos-duration="900" data-aos-delay="900">
            ...
            <section className={styled.next_handler}>
                <div className="container-main">
                    ...
                    <ul className={styled.next_handler_question_answer_list} data-aos="fade-up" data-aos-duration="900" data-aos-easing="linear" data-aos-delay="300">
            ...
            <section className={styled.next_sertificate}>
                <div className="container-main">
                    <div className={styled.next_sertificate_content} data-aos="fade-up" data-aos-duration="900" data-aos-easing="linear" data-aos-delay="300">
                        {sertificat}
                    </div>
                </div>
            </section>
